...
namespace Services
{
    public class TempTransactionAttachmentsAppService
    {
        //public TempTransactionAttachmentsAppService(ERP.Data.ApplicationDbContext context)
        //{
        //    _context = context;
        ...
        //    if (transactionId != 0)
        //    {
        //        //List<TempAttachment> entityList = Repository.GetAllList(x => x.TransactionId == transactionId).ToList();
        //        //if (entityList != null)
        //        //{
